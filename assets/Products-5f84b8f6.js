...
`;function so(n){const{onClose:e,addProdSuccess:i,product:r}=n,[t,a]=f.useState(100),s=t*r.calories,o=()=>{e(),i(s)};return x.jsxs(Xr,{children:[x.jsxs(Qr,{children:[x.jsx(Jr,{type:"text",value:r.title,readOnly:!0}),x.jsxs(Zr,{children:[x.jsx(eo,{type:"number",value:t,onChange:u=>a(u.target.value)}),x.jsx(to,{children:"grams"})]})]}),x.jsxs(no,{children:[x.jsx(io,{children:"Calories:"}),x.jsx(ro,{children:s})]}),x.jsxs(oo,{children:[x.jsx(ao,{onClick:o,children:"Add to diary"}),x.jsx(uo,{onClick:e,children:"Cancel"})]})]})}const lo=S.div`
  margin: 12px 70px;
  text-align: center;
  width: 157px;
...
`,bo=S.p`
  margin-right: 8px;
`;function xo(n){const{onClose:e,totalCalories:i}=n;return x.jsxs(lo,{children:[x.jsx(co,{}),x.jsx(po,{children:"Well Done"}),x.jsxs(fo,{children:[x.jsx(ho,{children:"Calories:"}),x.jsx(mo,{children:i})]}),x.jsx(vo,{onClick:e,children:"Next product"}),x.jsxs(go,{href:"Diary",children:[x.jsx(bo,{children:"To the diary"}),x.jsx("svg",{width:"16",height:"16",children:x.jsx("use",{href:"/src/assets/images/sprite/sprite.svg#arrow-add-prod"})})]})]})}const Eo=S.li`
  padding: 16px;
  border-radius: 12px;
...
`;function Ro({props:n}){const{weight:i,calories:r,category:t,title:a}=n,[s,o]=f.useState(!1),[u,l]=f.useState(!1),[d,p]=f.useState(null),m=()=>{o(!0)},b=()=>{o(!1),l(!1)},g=v=>{l(!0),p(v)};return x.jsxs(x.Fragment,{children:[x.jsxs(Eo,{children:[x.jsxs(Co,{children:[x.jsx(So,{children:"DIET"}),x.jsxs(Fo,{children:[x.jsx(yo,{recommended:!0}),x.jsx(wo,{children:"Recommended"}),x.jsxs(Do,{onClick:m,children:[x.jsx(Oo,{children:"Add"}),x.jsx(Ao,{children:x.jsx("use",{href:`${je}#arrow-add-prod-orange`})})]})]})]}),x.jsxs(Io,{children:[x.jsx(Mo,{children:x.jsx("use",{href:`${je}#run-man`})}),x.jsx(Vo,{children:a})]}),x.jsxs(Po,{children:[x.jsxs(we,{children:["Calories:",x.jsx(De,{children:r})]}),x.jsxs(we,{category:!0,children:["Category:",x.jsx(De,{children:t})]}),x.jsxs(we,{children:["Weight:",x.jsx(De,{children:i})]})]})]}),s&&x.jsx(He,{onClose:b,children:x.jsx(so,{onClose:b,addProdSuccess:g,product:n})}),u&&x.jsx(He,{onClose:b,children:x.jsx(xo,{onClose:b,totalCalories:d})})]})}const Lo=S.div`
  @media (min-width: 768px) {
    height: 660px;
  }
...
`;function ko({filter:n}){const[e,i]=f.useState([]),[r]=Yt();return f.useEffect(()=>{(async()=>{try{const a=await r(n).unwrap();i(a)}catch(a){console.error("Error fetching data:",a.message)}})()},[n]),x.jsx(Lo,{children:x.jsx(To,{children:e.map(({_id:t,...a})=>x.jsx(Ro,{props:a},t))})})}const Bo=S.div`
  position: absolute;
  top: -72px;
  right: -76px;
  width: 428px;
...
`;function _o(){const[n,e]=f.useState([]),[i,r]=f.useState(window.innerWidth>=1440),t=()=>{r(window.innerWidth>=1440)};return f.useEffect(()=>(window.addEventListener("resize",t),()=>{window.removeEventListener("resize",t)}),[]),x.jsxs(x.Fragment,{children:[i&&x.jsx(Bo,{}),x.jsxs(jo,{children:[x.jsx(qt,{text:"Products"}),x.jsx(Kr,{onProductsChange:e})]}),x.jsx(ko,{filter:n})]})}export{_o as Products};
