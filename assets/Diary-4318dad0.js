import{n as i,m as F,j as e,o as r,r as T,L as S,P,g as M,p as Y,I as R}from"./index-23b2d65c.js";import{T as N}from"./TitlePage-479f2518.js";import{C as U,f as _}from"./Calendar-c1d02db4.js";import"./tiny-warning.esm-c932d744.js";import"./setPrototypeOf-51e8cf87.js";const Q=i.div`
...
`;function Z(){const{data:n}=F();return e.jsxs(Q,{children:[e.jsxs(V,{children:[e.jsxs(a,{highlighted:!0,children:[e.jsxs(l,{children:[e.jsx(p,{children:e.jsx("use",{href:`${r}#food`})}),e.jsx(c,{highlighted:!0,children:"Daily calory intake"})]}),e.jsx(j,{children:n||2200})]}),e.jsxs(a,{highlighted:!0,children:[e.jsxs(l,{children:[e.jsx(p,{children:e.jsx("use",{href:`${r}#dumbbell`})}),e.jsx(c,{highlighted:!0,children:"Daily norm of sports"})]}),e.jsx(j,{children:"110 min"})]}),e.jsxs(a,{children:[e.jsxs(l,{children:[e.jsx(p,{children:e.jsx("use",{href:`${r}#apple`})}),e.jsx(c,{children:"Calories consumed"})]}),e.jsx(j,{children:"707"})]}),e.jsxs(a,{children:[e.jsxs(l,{children:[e.jsx(p,{children:e.jsx("use",{href:`${r}#fire`})}),e.jsx(c,{children:"Calories burned"})]}),e.jsx(j,{children:"855"})]}),e.jsxs(a,{caloriesOverConsumed:!0,children:[e.jsxs(l,{children:[e.jsx(p,{children:e.jsx("use",{href:`${r}#bubble`})}),e.jsx(c,{children:"The rest of the calories"})]}),e.jsx(j,{children:"1493"})]}),e.jsxs(a,{caloriesOverBurned:!0,children:[e.jsxs(l,{children:[e.jsx(p,{children:e.jsx("use",{href:`${r}#running`})}),e.jsx(c,{children:"The rest of sports"})]}),e.jsx(j,{children:"85 min"})]})]}),e.jsxs(G,{children:[e.jsx(J,{children:e.jsx(K,{children:e.jsx("use",{href:`${r}#exclamation-mark`})})}),e.jsx(X,{children:"Record all your meals in a calorie diary every day. This will help me be aware of my nutrition and make me responsible for my choices."})]})]})}const ee=i.div`
  @media screen and (max-width: 767px) {
    max-height: 1000px;
    max-width: 335px;
  }
...
`,xe=i.svg`
width:16px;
height: 16px;`;function he(){return e.jsxs(ne,{children:[e.jsxs(de,{children:[e.jsx(te,{children:"Exercises"}),e.jsxs(se,{to:"/exercises",children:[e.jsx(re,{children:"Add exercise"}),e.jsx(xe,{children:e.jsx("use",{href:`${r}#big_arrow`})})]})]}),e.jsx(ie,{})]})}const oe=i.div`
  @media screen and (max-width: 767px) {
    max-height: 762px;
    max-width: 335px;
  }
...
`,fe=i.svg`
width:16px;
height: 16px;`;function ge(){return e.jsxs(le,{children:[e.jsxs(ce,{children:[e.jsx(pe,{children:"Products"}),e.jsxs(je,{to:"/Products",children:[e.jsx(me,{children:"Add product"}),e.jsx(fe,{children:e.jsx("use",{href:`${r}#big_arrow`})})]})]}),e.jsx(ae,{})]})}const we=i.div`
  display: flex;
  align-items: center;
  gap: 20px;
...
`;function A({selectedDate:n,setSelectedDate:h}){const o=new Date(M(Y)),H=()=>{const v=new Date(n);v.setDate(n.getDate()-1),h(v)},L=()=>{const v=new Date(n);v.setDate(n.getDate()+1),h(v)},O=n.toDateString()===o.toDateString(),q=n.toDateString()===new Date().toDateString();return e.jsxs(we,{children:[e.jsx(ue,{children:e.jsx(U,{onChange:h,value:n,minDate:o,maxDate:new Date,children:e.jsxs(ye,{children:[e.jsxs(be,{children:[" ",_(n,"dd/MM/yyyy")]}),e.jsx(ve,{children:e.jsx(R,{name:"calendar"})})]})})}),e.jsxs("div",{children:[e.jsx(I,{disabled:O,onClick:H,children:e.jsx(R,{name:"nav-arrow-left"})}),e.jsx(I,{disabled:q,onClick:L,children:e.jsx(R,{name:"nav-arrow-right"})})]})]})}A.propTypes={selectedDate:P.instanceOf(Date).isRequired,setSelectedDate:P.func.isRequired};const Te=i.section`
  padding-top: 45px;
  padding-bottom: 80px;
