import{n as t,u as y,a as k,r as m,j as e,I as o,L as F,E as S,s as z}from"./index-0314b897.js";import{c as C,a as x,u as P,F as $,b as T,d as q}from"./index.esm-8baddb8c.js";import{T as E}from"./TitlePage-4cb3d2d6.js";import"./tiny-warning.esm-c932d744.js";const I=t.p`
...
`,L=C({name:x().trim("Name must not have leading or trailing spaces").strict().min(1).required("This is a required field"),email:x().email("Invalid email").matches("^([a-z0-9_-]+.)*[a-z0-9_-]+@[a-z0-9_-]+(.[a-z0-9_-]+)*.[a-z]{2,6}$","Enter valid values").required("This is a required field"),password:x().matches("^(?=.*?[A-Z])(?=.*?[a-z])(?=.*?[0-9])(?=.*?[#?!@$%^&*-]).{8,32}$","Password must be 8-32 characters long and include at least one digit, one lowercase letter, one uppercase letter and one special character").required("This is a required field")}),h=({...i})=>{const[s,a]=q(i),[d,c]=m.useState(!1),p=()=>c(!0),n=!!d&&s.value.trim().length>0||a.touched;return e.jsxs(A,{type:`${n?a.error?"invalid":"valid":""}`,children:[e.jsx("input",{...i,...s,onFocus:p}),e.jsx(U,{children:n?e.jsxs("div",{id:`${i.id}-feedback`,"aria-live":"polite",children:[e.jsx(o,{name:"checkmark"}),a.error?a.error:e.jsxs(e.Fragment,{children:["Success ",i.name]})]}):null})]})};function H(){const i=y(),[s,{isLoading:a,isError:d,error:c}]=k(),[p,n]=m.useState(),[u,g]=m.useState(!1),w=()=>{g(!0)},r=document.querySelector("#password"),f=()=>{r&&(r.getAttribute("type")==="password"?(r.setAttribute("type","text"),n(!0)):(r.setAttribute("type","password"),n(!1)))},v=P({initialValues:{name:"",email:"",password:""},onSubmit:async(b,{resetForm:j})=>{try{const l=await s(b).unwrap();i(z(l)),j()}catch(l){console.error(l)}},validationSchema:L});return e.jsxs(e.Fragment,{children:[e.jsx($,{value:v,children:e.jsxs(T,{children:[e.jsx(I,{children:"Thank you for your interest in our platform. To complete the registration process, please provide us with the following information."}),e.jsxs(B,{children:[e.jsx(h,{name:"name",type:"text",placeholder:"Name"}),e.jsx(h,{name:"email",type:"email",placeholder:"Email"}),e.jsxs("div",{children:[e.jsx(h,{name:"password",type:"password",placeholder:"Password",id:"password",onInput:w}),u&&e.jsx("button",{type:"button",onClick:f,children:p?e.jsx(o,{name:"eye"}):e.jsx(o,{name:"eye-off"})})]})]}),e.jsxs(_,{children:[e.jsx("button",{type:"submit",children:"Sign Up"}),e.jsx("button",{type:"button",id:"google",children:e.jsx(o,{name:"google"})})]}),e.jsxs(D,{children:[e.jsx("p",{children:"Already have account?"}),e.jsx(F,{to:"/signin",children:"Sign In"})]})]})}),e.jsx(S,{isLoading:a,isError:d,error:c})]})}const M=t.div`
  padding-top: 127px;
