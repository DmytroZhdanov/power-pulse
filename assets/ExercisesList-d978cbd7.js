import{x as L,r as p,n as r,P as m,j as t,I as G,a0 as xe,Q as A,a1 as he,L as ne,R as me,p as B,Z as ge,Y as fe,b as be,a2 as we,$ as ye,E as Q}from"./index-c866a3ac.js";import{u as N}from"./upperCase-5e800fdd.js";import{f as ve,C as je}from"./Calendar-0ab85e07.js";import"./tiny-warning.esm-c932d744.js";var H=typeof window>"u"?p.useEffect:p.useLayoutEffect,Se=({isPlaying:e,duration:i,startAt:d=0,updateInterval:n=0,onComplete:o,onUpdate:a})=>{let[s,c]=p.useState(d),u=p.useRef(0),x=p.useRef(d),f=p.useRef(d*-1e3),l=p.useRef(null),h=p.useRef(null),b=p.useRef(null),y=S=>{let g=S/1e3;if(h.current===null){h.current=g,l.current=requestAnimationFrame(y);return}let w=g-h.current,E=u.current+w;h.current=g,u.current=E;let R=x.current+(n===0?E:(E/n|0)*n),T=x.current+E,$=typeof i=="number"&&T>=i;c($?i:R),$||(l.current=requestAnimationFrame(y))},v=()=>{l.current&&cancelAnimationFrame(l.current),b.current&&clearTimeout(b.current),h.current=null},j=p.useCallback(S=>{v(),u.current=0;let g=typeof S=="number"?S:d;x.current=g,c(g),e&&(l.current=requestAnimationFrame(y))},[e,d]);return H(()=>{if(a==null||a(s),i&&s>=i){f.current+=i*1e3;let{shouldRepeat:S=!1,delay:g=0,newStartAt:w}=(o==null?void 0:o(f.current/1e3))||{};S&&(b.current=setTimeout(()=>j(w),g*1e3))}},[s,i]),H(()=>(e&&(l.current=requestAnimationFrame(y)),v),[e,i,n]),{elapsedTime:s,reset:j}},Ee=(e,i,d)=>{let n=e/2,o=i/2,a=n-o,s=2*a,c=d==="clockwise"?"1,0":"0,1",u=2*Math.PI*a;return{path:`m ${n},${o} a ${a},${a} 0 ${c} 0,${s} a ${a},${a} 0 ${c} 0,-${s}`,pathLength:u}},K=(e,i)=>e===0||e===i?0:typeof i=="number"?e-i:0,Re=e=>({position:"relative",width:e,height:e}),$e={display:"flex",justifyContent:"center",alignItems:"center",position:"absolute",left:0,top:0,width:"100%",height:"100%"},se=(e,i,d,n,o)=>{if(n===0)return i;let a=(o?n-e:e)/n;return i+d*a},X=e=>{var i,d;return(d=(i=e.replace(/^#?([a-f\d])([a-f\d])([a-f\d])$/i,(n,o,a,s)=>`#${o}${o}${a}${a}${s}${s}`).substring(1).match(/.{2}/g))==null?void 0:i.map(n=>parseInt(n,16)))!=null?d:[]},ke=(e,i)=>{var d;let{colors:n,colorsTime:o,isSmoothColorTransition:a=!0}=e;if(typeof n=="string")return n;let s=(d=o==null?void 0:o.findIndex((h,b)=>h>=i&&i>=o[b+1]))!=null?d:-1;if(!o||s===-1)return n[0];if(!a)return n[s];let c=o[s]-i,u=o[s]-o[s+1],x=X(n[s]),f=X(n[s+1]),l=!!e.isGrowing;return`rgb(${x.map((h,b)=>se(c,h,f[b]-h,u,l)|0).join(",")})`},Te=e=>{let{duration:i,initialRemainingTime:d,updateInterval:n,size:o=180,strokeWidth:a=12,trailStrokeWidth:s,isPlaying:c=!1,isGrowing:u=!1,rotation:x="clockwise",onComplete:f,onUpdate:l}=e,h=p.useRef(),b=Math.max(a,s??0),{path:y,pathLength:v}=Ee(o,b,x),{elapsedTime:j}=Se({isPlaying:c,duration:i,startAt:K(i,d),updateInterval:n,onUpdate:typeof l=="function"?g=>{let w=Math.ceil(i-g);w!==h.current&&(h.current=w,l(w))}:void 0,onComplete:typeof f=="function"?g=>{var w;let{shouldRepeat:E,delay:R,newInitialRemainingTime:T}=(w=f(g))!=null?w:{};if(E)return{shouldRepeat:E,delay:R,newStartAt:K(i,T)}}:void 0}),S=i-j;return{elapsedTime:j,path:y,pathLength:v,remainingTime:Math.ceil(S),rotation:x,size:o,stroke:ke(e,S),strokeDashoffset:se(j,0,v,i,u),strokeWidth:a}},oe=e=>{let{children:i,strokeLinecap:d,trailColor:n,trailStrokeWidth:o}=e,{path:a,pathLength:s,stroke:c,strokeDashoffset:u,remainingTime:x,elapsedTime:f,size:l,strokeWidth:h}=Te(e);return L.createElement("div",{style:Re(l)},L.createElement("svg",{viewBox:`0 0 ${l} ${l}`,width:l,height:l,xmlns:"http://www.w3.org/2000/svg"},L.createElement("path",{d:a,fill:"none",stroke:n??"#d9d9d9",strokeWidth:o??h}),L.createElement("path",{d:a,fill:"none",stroke:c,strokeLinecap:d??"round",strokeWidth:h,strokeDasharray:s,strokeDashoffset:u})),typeof i=="function"&&L.createElement("div",{style:$e},i({remainingTime:x,elapsedTime:f,color:c})))};oe.displayName="CountdownCircleTimer";const Ce=r.div`
  @keyframes spin {
    0% {
...
`,ce=({timerLabel:e,duration:i,setTimer:d,roundsCount:n,setRoundsCount:o,stopTimer:a,setStopTimer:s})=>{const[c,u]=p.useState(!1);p.useEffect(()=>{a&&(u(!a),s(!1))},[s,a]);const x=()=>{u(!c)},f=({remainingTime:l})=>{const h=i-l,b=Math.floor(h/60),y=h%60;return t.jsxs(Le,{children:[t.jsx(Z,{children:`
...
`;function pe({exercise:e,openModalExerciseSuccess:i,closeModalExerciseForm:d,setModalExerciseSuccessData:n}){const{_id:o,gifUrl:a,burnedCalories:s,time:c}=e,[u,x]=p.useState(!1),[f,l]=p.useState(!1),[h,b]=p.useState(""),[y,v]=p.useState(""),[j,S]=p.useState(0),[g,w]=p.useState(0),[E,R]=p.useState(!1),[T]=xe(),$=s/c,k=Math.floor(j/60*$+g*s),D=j+g*c*60,I=async({time:M=D,date:P=new Date})=>{R(!0);const z=Math.floor(M/60*$+g*s),F={exercise_ID:o,date:P,time:M,calories:z};if(F.time<60){b(`To achieve results, the training time should be more than one minute. Your time ${F.time} sec.`),v("Notice: "),l(!0);return}const{error:_}=await T(F);_?(v("Error: "),b(_.data.message),l(!0)):(i(),d(),n(F))},W=()=>{R(!0),x(!0)},C={timerLabel:"Time",caloriesLabel:"Burned calories:",addExerciseBtnName:"Add to diary",openPastDaysFormBtnName:"Missing exercises? Add them here"};return t.jsxs(Ge,{children:[t.jsxs(Ye,{children:[t.jsx(Qe,{src:a,alt:"Exercise technique"}),t.jsx(ce,{timerLabel:C.timerLabel,stopTimer:E,setStopTimer:R,roundsCount:g,setRoundsCount:w,setTimer:S,duration:c*60}),t.jsxs(He,{children:[t.jsx(Ke,{children:C.caloriesLabel}),t.jsx(Xe,{children:k})]})]}),t.jsxs(_e,{children:[t.jsx(le,{exercise:e}),t.jsxs(Ze,{children:[t.jsx(Je,{onClick:W,children:C.openPastDaysFormBtnName}),t.jsx(et,{onClick:I,children:C.addExerciseBtnName})]})]}),t.jsx(A,{onShow:u,onClose:()=>{x(!1)},children:t.jsx(de,{onClose:()=>{x(!1)},onSubmit:I})}),t.jsx(A,{onShow:f,onClose:()=>{l(!1)},children:t.jsx(he,{notificationType:y,message:h})})]})}pe.propTypes={openModalExerciseSuccess:m.func.isRequired,closeModalExerciseForm:m.func.isRequired,setModalExerciseSuccessData:m.func.isRequired,exercise:m.shape({gifUrl:m.string.isRequired,burnedCalories:m.number.isRequired,time:m.number.isRequired}).isRequired};const tt=r.div`
  display: flex;
  flex-direction: column;
  align-items: center;
  padding-top: 48px;
...
`,kt=r.div``;var Y=new Map,q=new WeakMap,re=0,Tt=void 0;function Ct(e){return e?(q.has(e)||(re+=1,q.set(e,re.toString())),q.get(e)):"0"}function Dt(e){return Object.keys(e).sort().filter(i=>e[i]!==void 0).map(i=>`${i}_${i==="root"?Ct(e.root):e[i]}`).toString()}function Lt(e){let i=Dt(e),d=Y.get(i);if(!d){const n=new Map;let o;const a=new IntersectionObserver(s=>{s.forEach(c=>{var u;const x=c.isIntersecting&&o.some(f=>c.intersectionRatio>=f);e.trackVisibility&&typeof c.isVisible>"u"&&(c.isVisible=x),(u=n.get(c.target))==null||u.forEach(f=>{f(x,c)})})},e);o=a.thresholds||(Array.isArray(e.threshold)?e.threshold:[e.threshold||0]),d={id:i,observer:a,elements:n},Y.set(i,d)}return d}function It(e,i,d={},n=Tt){if(typeof window.IntersectionObserver>"u"&&n!==void 0){const u=e.getBoundingClientRect();return i(n,{isIntersecting:n,target:e,intersectionRatio:typeof d.threshold=="number"?d.threshold:0,time:0,boundingClientRect:u,intersectionRect:u,rootBounds:u}),()=>{}}const{id:o,observer:a,elements:s}=Lt(d);let c=s.get(e)||[];return s.has(e)||s.set(e,c),c.push(i),a.observe(e),function(){c.splice(c.indexOf(i),1),c.length===0&&(s.delete(e),a.unobserve(e)),s.size===0&&(a.disconnect(),Y.delete(o))}}function Mt({threshold:e,delay:i,trackVisibility:d,rootMargin:n,root:o,triggerOnce:a,skip:s,initialInView:c,fallbackInView:u,onChange:x}={}){var f;const[l,h]=p.useState(null),b=p.useRef(),[y,v]=p.useState({inView:!!c,entry:void 0});b.current=x,p.useEffect(()=>{if(s||!l)return;let w;return w=It(l,(E,R)=>{v({inView:E,entry:R}),b.current&&b.current(E,R),R.isIntersecting&&a&&w&&(w(),w=void 0)},{root:o,rootMargin:n,threshold:e,trackVisibility:d,delay:i},u),()=>{w&&w()}},[Array.isArray(e)?e.toString():e,l,o,n,a,s,d,u,i]);const j=(f=y.entry)==null?void 0:f.target,S=p.useRef();!l&&j&&!a&&!s&&S.current!==j&&(S.current=j,v({inView:!!c,entry:void 0}));const g=[h,y.inView,y.entry];return g.ref=g[0],g.inView=g[1],g.entry=g[2],g}function Bt(){var T;const e=ge(),[i,d]=p.useState(1),[n,o]=p.useState(!0),[a,s]=p.useState([]),{subcategory:c}=fe(),{ref:u}=Mt({onChange:$=>$&&o(!0)}),x=be(),f=p.useRef(((T=x.state)==null?void 0:T.from)??"/exercises"),l=p.useRef(),[h,{isLoading:b,isError:y,error:v}]=we(),{data:j,isFetching:S,isError:g,error:w}=ye(e),E=j&&j.filter($=>$.name===c)[0],R=E?E.imgURL:null;return p.useEffect(()=>{n&&(async()=>{try{const k=await h({page:i,[e]:c}).unwrap();if(k.data.length===0)return;s(i===1?[...k.data]:D=>[...D,...k.data]),o(!1),d(i+1)}catch(k){console.log(k)}})()},[i,h,n,e,c]),t.jsxs(kt,{children:[t.jsxs(St,{to:f.current,children:[t.jsx(Et,{children:t.jsx("use",{href:`${B}#icon-arrow`})}),t.jsx(jt,{children:"Back"})]}),t.jsx(vt,{ref:l,children:a==null?void 0:a.map(({_id:$,name:k,bodyPart:D,burnedCalories:I,target:W,gifUrl:C,time:M,equipment:P},z)=>t.jsx(Rt,{ref:z===a.length-1?u:null,children:t.jsx(yt,{_id:$,bodyPart:D,equipment:P,gifUrl:C,name:k,target:W,burnedCalories:I,time:M},$)},z))}),t.jsx($t,{category:e,img:R}),t.jsx(Q,{isLoading:S,isError:g,error:w}),t.jsx(Q,{isLoading:b,isError:y,error:v})]})}export{Bt as ExercisesList};
