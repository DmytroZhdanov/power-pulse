import{n as s,j as t,D as r,e as y,f as F,r as n,g as E,R as g,h as W,i as k,k as C,B as $,T as H,l as A}from"./index-29351043.js";import{u as q,F as z,a as B}from"./formik.esm-9fd9ad92.js";import{s as R,S as P}from"./SecondStep-49dee0dc.js";import{m as u}from"./motion-59849731.js";import{FirstStep as N}from"./FirstStep-a961cca9.js";import{c as M,b as v,a as w}from"./index.esm-57d5e939.js";import{D as O}from"./inputData-4a079f06.js";import{f as U}from"./Calendar-9c06cb97.js";import"./tiny-warning.esm-c932d744.js";const L=s.div`
  max-width: 375px;
...
`,_=(e,i,o)=>{if(e===r.FIRST)if(!i.values.height||!i.values.currentWeight||!i.values.desiredWeight){i.setFieldTouched("height",!0,!0),i.setFieldTouched("currentWeight",!0,!0),i.setFieldTouched("desiredWeight",!0,!0);return}else o(e===r.FIRST?r.SECOND:r.THIRD);if(e===r.SECOND)if(!i.values.blood||!i.values.sex||!i.values.levelActivity){i.setFieldTouched("blood",!0,!0),i.setFieldTouched("sex",!0,!0),i.setFieldTouched("levelActivity",!0,!0);return}else o(e===r.FIRST?r.THIRD:r.THIRD)},J=(e,i)=>i(e===r.THIRD?r.SECOND:r.FIRST),K=new Date(2006,1,1);K.getFullYear();const Z=M({height:v().typeError("Height must be a number").moreThan(150,"Height must be greater than 150").required("Height is a required field"),currentWeight:v().typeError("Weight must be a number").moreThan(35,"Weight must be greater than 35").required("Weight is a required field"),desiredWeight:v().typeError("Weight must be a number").moreThan(35,"Weight must be greater than 35").required("Weight is a required field"),blood:w().required("Blood is a required field"),sex:w().required("Sex is a required field"),levelActivity:w().required("Level Activity is a required field")}),ee=({step:e,formik:i})=>{const o=y();return t.jsxs(X,{children:[e===r.THIRD&&t.jsx(u.div,{whileHover:{scale:1.02},whileTap:{scale:.9},children:t.jsx(V,{type:"submit",id:"btn",children:"Go"})}),e!==r.FIRST&&t.jsx(u.div,{whileHover:{translateX:-2},children:t.jsxs(Q,{type:"button",onClick:()=>{J(e,o)},children:[t.jsx(I,{children:t.jsx("svg",{children:t.jsx("use",{href:`${F}#big-arrow-left`})})}),"Back"]})}),e!==r.THIRD&&t.jsx(u.div,{children:t.jsxs(Y,{type:"button",onClick:()=>{_(e,i,o)},children:["Next",t.jsx(I,{children:t.jsx("svg",{children:t.jsx("use",{href:`${F}#big-arrow-right`})})})]})})]})},te=({userParams:e,step:i})=>{const[o,m]=n.useState(new Date),[l,f]=n.useState(!1),b=y(),[x]=E(),a=q({initialValues:e,validationSchema:Z,onSubmit:async h=>{const c={...h,birthday:U(o,"yyyy-MM-dd")};await x(c),a.resetForm(),b(`../${g.DIARY}`)}});return t.jsx(u.div,{variants:R,initial:"hidden",animate:"visible",exit:"hidden",transition:{duration:.5},children:t.jsxs(O,{children:[t.jsx(G,{step:i}),t.jsx(z,{value:a,children:t.jsxs(B,{children:[i===r.FIRST&&t.jsx(N,{setIsDateSelected:f,isDateSelected:l,selectedDate:o,setSelectedDate:m,formik:a}),i===r.SECOND&&t.jsx(P,{formik:a}),t.jsx(ee,{step:i,formik:a})]})})]})},i)},ie=s.div`
  display: flex;
