...
`;function fo({selectedDate:t,setSelectedDate:e}){const i=dt(t,"dd.MM.yyyy");return h.jsx(cn,{maxDate:new Date,onChange:e,value:t,children:h.jsxs(lo,{children:[h.jsx(co,{children:i}),h.jsx(po,{children:h.jsx(nn,{name:"calendar"})})]})})}const ho=S.div`
  padding: 48px 24px;
...
`;function _t(t){const[e,i]=f.useState(new Date),{onClose:r,addProdSuccess:n,addProdError:a,product:s}=t,{weight:o,calories:u,_id:l,title:c}=s,[d,g]=f.useState(o),x=d*u/100,[E]=rn(),b={product_ID:l,date:dt(new Date(e),"yyyy-MM-dd"),amount:d,calories:x},v=async()=>{const{error:m}=await E(b);m?a(m.data.message):(r(),n(x))};return h.jsxs(ho,{children:[h.jsxs(mo,{children:[h.jsx(vo,{type:"text",value:c,readOnly:!0,disabled:!0}),h.jsxs(go,{children:[h.jsx(bo,{type:"number",value:d,onChange:m=>g(m.target.value)}),h.jsx(xo,{children:"grams"})]})]}),h.jsxs(Fo,{children:[h.jsx(fo,{selectedDate:e,setSelectedDate:i}),h.jsxs(Eo,{children:[h.jsx(Co,{children:"Calories:"}),h.jsx(So,{children:x})]})]}),h.jsxs(yo,{children:[h.jsx(wo,{onClick:v,children:"Add to diary"}),h.jsx(Do,{onClick:r,children:"Cancel"})]})]})}_t.propTypes={onClose:k.func.isRequired,addProdSuccess:k.func.isRequired,addProdError:k.func.isRequired,product:k.shape({weight:k.number.isRequired,calories:k.number.isRequired,_id:k.string.isRequired,title:k.string.isRequired}).isRequired};const Oo=S.div`
  margin: 12px 70px;
  text-align: center;
  width: 157px;
...
`;function Nt({props:t,userGroupBlood:e}){const{weight:i,calories:r,category:n,title:a,groupBloodNotAllowed:s}=t,o=s[e],[u,l]=f.useState(!1),[c,d]=f.useState(!1),[g,x]=f.useState(!1),[E,b]=f.useState(null),[v,m]=f.useState(""),p=()=>{l(!0)},C=()=>{l(!1),d(!1),x(!1)},O=w=>{d(!0),b(w)},P=w=>{x(!0),m(w)};return h.jsxs(h.Fragment,{children:[h.jsxs($o,{children:[h.jsxs(Bo,{children:[h.jsx(jo,{children:"DIET"}),h.jsxs(Ho,{children:[h.jsx(zo,{recommended:o}),h.jsx(Uo,{children:o?"Recommended":"Not recommended"}),h.jsxs(_o,{onClick:p,children:[h.jsx(No,{children:"Add"}),h.jsx(Wo,{children:h.jsx("use",{href:`${pe}#arrow-add-prod-orange`})})]})]})]}),h.jsxs(Go,{children:[h.jsx(qo,{children:h.jsx("use",{href:`${pe}#run-man`})}),h.jsx(Yo,{children:a})]}),h.jsxs(Xo,{children:[h.jsxs(Ae,{children:["Calories:",h.jsx(Ie,{children:r})]}),h.jsxs(Ae,{category:!0,children:["Category:",h.jsx(Ie,{children:n})]}),h.jsxs(Ae,{children:["Weight:",h.jsx(Ie,{children:i})]})]})]}),h.jsx(Ce,{onClose:C,onShow:u,children:h.jsx(_t,{onClose:C,addProdSuccess:O,product:t,addProdError:P})}),h.jsx(Ce,{onClose:C,onShow:c,children:h.jsx(To,{onClose:C,totalCalories:E,addProdError:P})}),h.jsx(Ce,{onClose:C,onShow:g,children:h.jsx(on,{message:v,onClose:C})})]})}Nt.propTypes={props:k.shape({weight:k.number.isRequired,calories:k.number.isRequired,category:k.string.isRequired,title:k.string.isRequired,groupBloodNotAllowed:k.object.isRequired}).isRequired,userGroupBlood:k.number};const Ko=S.ul`
  @media screen and (min-width: ${({theme:t})=>t.breakpoint.tablet}) {
    height: 660px;
    display: flex;
    flex-wrap: wrap;
...
`;function Wt({filter:t}){const[e,i]=f.useState([]),[r,n]=f.useState(null),[a,s]=f.useState(t),[o,u]=f.useState(1),[l,c]=f.useState(18),[d,g]=f.useState(1e3),[x,{isLoading:E,isError:b,error:v}]=an(),{isSuccess:m,data:p,isLoading:C,isError:O,error:P}=un(),{ref:w}=ln({onChange:I=>{I&&u(A=>A+1)}});return f.useEffect(()=>{m&&n(p)},[m,p]),f.useEffect(()=>{if(t!==a&&(c(18),g(1e3),s(t),u(1)),d/l<o)return;(async()=>{try{const M=await x({page:o,...a}).unwrap();g(M.total),c(M.limit),i(o===1?[...M.data]:$=>[...$,...M.data])}catch(M){console.error("Error fetching data:",M.message)}})()},[a,x,o,t,d,l]),h.jsxs(h.Fragment,{children:[e.length>0?h.jsx(Ko,{children:e.map((I,A)=>h.jsx("li",{ref:A===e.length-1?w:null,children:h.jsx(Nt,{props:I,userGroupBlood:r},I._id)},A))}):h.jsxs(h.Fragment,{children:[h.jsxs(Qo,{children:[h.jsx(Zo,{children:"Sorry, no results were found"})," for the product filters you selected. You may want to consider other search options to find the product you want. Our range is wide and you have the opportunity to find more options that suit your needs."]}),h.jsx(Jo,{children:"Try changing the search parameters."})]}),h.jsx(ze,{isLoading:E,isError:b,error:v}),h.jsx(ze,{isLoading:C,isError:O,error:P})]})}Wt.propTypes={filter:k.object};const ea=S.div`
  position: absolute;
  top: -72px;
  right: -76px;
  width: 428px;
