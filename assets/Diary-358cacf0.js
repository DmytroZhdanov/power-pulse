...
`,Ze=r.svg`
  width: 16px;
  height: 16px;
`;function ce({diaryExercises:e,setDiaryExercises:o,isLoading:s}){return t.jsxs(Qe,{children:[t.jsxs(Ve,{children:[t.jsx(Ye,{children:"Exercises"}),t.jsxs(Je,{to:"/exercises",children:[t.jsx(Xe,{children:"Add exercise"}),t.jsx(Ze,{children:t.jsx("use",{href:`${D}#big_arrow`})})]})]}),e&&e.length!==0?t.jsx(le,{diaryExercises:e,setDiaryExercises:o}):t.jsx(t.Fragment,{children:t.jsx(A,{children:s?t.jsx(Ke,{children:t.jsx(se,{color:"#E6533C",ariaLabel:"three-dots-loading"})}):t.jsx(Ge,{as:B.p,initial:{opacity:0},animate:{opacity:1},transition:{duration:.5},exit:{opacity:0},children:"Not found exercises"})})})]})}ce.propTypes={isLoading:i.bool,diaryExercises:i.arrayOf(i.shape({bodyPart:i.string.isRequired,calories:i.number.isRequired,date:i.string.isRequired,equipment:i.string.isRequired,exercise_ID:i.string.isRequired,name:i.string.isRequired,target:i.string.isRequired,time:i.number.isRequired,_id:i.string.isRequired})).isRequired,setDiaryExercises:i.func.isRequired};const et=r.div`
  scroll-behavior: auto;
  overflow-y: auto;
  overflow-x: hidden;
...
`;function $t(){const[e,o]=a.useState(new Date),[s,d]=a.useState([]),[w,m]=a.useState([]),[c,{isLoading:x,isError:f,error:g}]=$e(),{data:l,isFetching:n,isError:u,error:y}=ke(),p=e.getFullYear()+"-"+(e.getMonth()+1)+"-"+e.getDate();return a.useEffect(()=>{(async()=>{const E=await c(p);m(E.data.exerciseResult),d(E.data.productResult)})()},[c,p]),t.jsxs(ut,{children:[t.jsxs(mt,{children:[t.jsx(Re,{text:"Diary"}),t.jsx(xe,{selectedDate:e,setSelectedDate:o})]}),t.jsxs(ft,{children:[t.jsx(de,{bmrData:l,diaryProducts:s,diaryExercises:w}),t.jsxs(gt,{children:[t.jsx(he,{isLoading:x,setDiaryProducts:d,diaryProducts:s}),t.jsx(ce,{isLoading:x,diaryExercises:w,setDiaryExercises:m})]})]}),t.jsx(I,{isLoading:x,isError:f,error:g,showLoader:!1}),t.jsx(I,{isLoading:n,isError:u,error:y,showLoader:!1})]})}export{$t as Diary};
