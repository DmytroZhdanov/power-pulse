...
`;function Nt(t){const[e,i]=f.useState(new Date),{onClose:r,addProdSuccess:n,addProdError:a,product:s}=t,{weight:o,calories:u,_id:l,title:c}=s,[d,g]=f.useState(o),x=d*u/100,[E]=an(),b={product_ID:l,date:dt(new Date(e),"yyyy-MM-dd"),amount:d,calories:x},v=async()=>{const{error:m}=await E(b);m?a(m.data.message):(r(),n(x))};return h.jsxs(vo,{children:[h.jsxs(go,{children:[h.jsx(bo,{type:"text",value:c,readOnly:!0,disabled:!0}),h.jsxs(xo,{children:[h.jsx(Eo,{type:"number",value:d,onChange:m=>g(m.target.value)}),h.jsx(Co,{children:"grams"})]})]}),h.jsxs(Do,{children:[h.jsx(_t,{selectedDate:e,setSelectedDate:i}),h.jsxs(So,{children:[h.jsx(yo,{children:"Calories:"}),h.jsx(Fo,{children:x})]})]}),h.jsxs(wo,{children:[h.jsx(Oo,{onClick:v,children:"Add to diary"}),h.jsx(Ao,{onClick:r,children:"Cancel"})]})]})}Nt.propTypes={onClose:R.func.isRequired,addProdSuccess:R.func.isRequired,addProdError:R.func.isRequired,product:R.shape({weight:R.number.isRequired,calories:R.number.isRequired,_id:R.string.isRequired,title:R.string.isRequired}).isRequired};const Io="/power-pulse/assets/avocado-b622cf8b.png",Po=S.div`
  margin: 12px 70px;
  text-align: center;
  width: 157px;
...
`,Bo=S.p`
  margin-right: 8px;
`;function Wt({onClose:t,totalCalories:e}){return h.jsxs(Po,{children:[h.jsx(Mo,{}),h.jsx(Vo,{children:"Well Done"}),h.jsxs(Ro,{children:[h.jsx(Lo,{children:"Calories:"}),h.jsx(ko,{children:e})]}),h.jsx(To,{onClick:t,children:"Next product"}),h.jsxs($o,{href:"Diary",children:[h.jsx(Bo,{children:"To the diary"}),h.jsx("svg",{width:"16",height:"16",children:h.jsx("use",{href:"/src/assets/images/sprite/sprite.svg#arrow-add-prod"})})]})]})}Wt.propTypes={totalCalories:R.number,onClose:R.func.isRequired};const jo=S.div`
  padding: 16px;
  border-radius: 12px;
...
`;function Gt({props:t,userGroupBlood:e}){const{weight:i,calories:r,category:n,title:a,groupBloodNotAllowed:s}=t,o=s[e],[u,l]=f.useState(!1),[c,d]=f.useState(!1),[g,x]=f.useState(!1),[E,b]=f.useState(null),[v,m]=f.useState(""),p=()=>{l(!0)},C=()=>{l(!1),d(!1),x(!1)},O=w=>{d(!0),b(w)},P=w=>{x(!0),m(w)};return h.jsxs(h.Fragment,{children:[h.jsxs(jo,{children:[h.jsxs(Ho,{children:[h.jsx(zo,{children:"DIET"}),h.jsxs(Uo,{children:[h.jsx(_o,{recommended:o}),h.jsx(No,{children:o?"Recommended":"Not recommended"}),h.jsxs(Wo,{onClick:p,children:[h.jsx(Go,{children:"Add"}),h.jsx(qo,{children:h.jsx("use",{href:`${pe}#arrow-add-prod-orange`})})]})]})]}),h.jsxs(Yo,{children:[h.jsx(Xo,{children:h.jsx("use",{href:`${pe}#run-man`})}),h.jsx(Ko,{children:a})]}),h.jsxs(Qo,{children:[h.jsxs(Ae,{children:["Calories:",h.jsx(Ie,{children:r})]}),h.jsxs(Ae,{category:!0,children:["Category:",h.jsx(Ie,{children:n})]}),h.jsxs(Ae,{children:["Weight:",h.jsx(Ie,{children:i})]})]})]}),h.jsx(Ce,{onClose:C,onShow:u,children:h.jsx(Nt,{onClose:C,addProdSuccess:O,product:t,addProdError:P})}),h.jsx(Ce,{onClose:C,onShow:c,children:h.jsx(Wt,{onClose:C,totalCalories:E,addProdError:P})}),h.jsx(Ce,{onClose:C,onShow:g,children:h.jsx(sn,{message:v,onClose:C})})]})}Gt.propTypes={props:R.shape({weight:R.number.isRequired,calories:R.number.isRequired,category:R.string.isRequired,title:R.string.isRequired,groupBloodNotAllowed:R.object.isRequired}).isRequired,userGroupBlood:R.number};const Zo=S.ul`
  @media screen and (min-width: ${({theme:t})=>t.breakpoint.tablet}) {
    height: 660px;
    display: flex;
    flex-wrap: wrap;
...
`;function qt({filter:t}){const[e,i]=f.useState([]),[r,n]=f.useState(null),[a,s]=f.useState(t),[o,u]=f.useState(1),[l,c]=f.useState(18),[d,g]=f.useState(1e3),[x,{isLoading:E,isError:b,error:v}]=ln(),{isSuccess:m,data:p,isLoading:C,isError:O,error:P}=cn(),{ref:w}=pn({onChange:I=>{I&&u(A=>A+1)}});return f.useEffect(()=>{m&&n(p)},[m,p]),f.useEffect(()=>{if(t!==a&&(c(18),g(1e3),s(t),u(1)),d/l<o)return;(async()=>{try{const M=await x({page:o,...a}).unwrap();g(M.total),c(M.limit),i(o===1?[...M.data]:$=>[...$,...M.data])}catch(M){console.error("Error fetching data:",M.message)}})()},[a,x,o,t,d,l]),h.jsxs(h.Fragment,{children:[e.length>0?h.jsx(Zo,{children:e.map((I,A)=>h.jsx("li",{ref:A===e.length-1?w:null,children:h.jsx(Gt,{props:I,userGroupBlood:r},I._id)},A))}):h.jsxs(h.Fragment,{children:[h.jsxs(Jo,{children:[h.jsx(ea,{children:"Sorry, no results were found"})," for the product filters you selected. You may want to consider other search options to find the product you want. Our range is wide and you have the opportunity to find more options that suit your needs."]}),h.jsx(ta,{children:"Try changing the search parameters."})]}),h.jsx(ze,{isLoading:E,isError:b,error:v}),h.jsx(ze,{isLoading:C,isError:O,error:P})]})}qt.propTypes={filter:R.object};const na=S.div`
  position: absolute;
  top: -72px;
  right: -76px;
  width: 428px;
...
`;function la(){const[t,e]=f.useState(null),[i,r]=f.useState(window.innerWidth>=1440),n=()=>{r(window.innerWidth>=1440)};return f.useEffect(()=>(window.addEventListener("resize",n),()=>{window.removeEventListener("resize",n)}),[]),h.jsxs(h.Fragment,{children:[i&&h.jsx(na,{}),h.jsxs(ia,{children:[h.jsx(dn,{text:"Products"}),h.jsx(Ut,{onProductsChange:e})]}),h.jsx(qt,{filter:t})]})}export{la as Products};
