...
`;function Yo(){const[n,e]=f.useState([]),[i,r]=f.useState(window.innerWidth>=1440),t=()=>{r(window.innerWidth>=1440)};return f.useEffect(()=>(window.addEventListener("resize",t),()=>{window.removeEventListener("resize",t)}),[]),m.jsxs(m.Fragment,{children:[i&&m.jsx(Uo,{}),m.jsxs(No,{children:[m.jsx(Kt,{text:"Products"}),m.jsx(Qr,{onProductsChange:e})]}),m.jsx(zo,{filter:n})]})}export{Yo as Products};
