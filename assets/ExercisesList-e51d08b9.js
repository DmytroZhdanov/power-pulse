...
`,le=({exercise:e})=>{const{bodyPart:i,equipment:d,name:n,target:o,time:a}=e;return t.jsx(Ue,{children:[{label:"Name",value:n},{label:"Target",value:o},{label:"Body Part",value:i},{label:"Equipment",value:d},{label:"Time",value:`${a} minutes`}].map(({label:s,value:c})=>t.jsxs(Ne,{children:[t.jsx(Oe,{children:s}),t.jsx(Ve,{children:c})]},s+c))})};le.propTypes={exercise:m.shape({bodyPart:m.string.isRequired,equipment:m.string.isRequired,name:m.string.isRequired,target:m.string.isRequired,time:m.number.isRequired}).isRequired};const Ge=r.div`
  display: grid;
  padding: 48px 16px;
  width: 335px;
  height: 570px;
...
`;function yt(e){const{bodyPart:i,gifUrl:d,name:n,target:o,burnedCalories:a}=e,[s,c]=p.useState(!1),[u,x]=p.useState(!1),[f,l]=p.useState({}),h=()=>{c(!0)},b=()=>{x(!0)},y=()=>{c(!1)},v=()=>{x(!1)};return t.jsxs(t.Fragment,{children:[t.jsxs(dt,{gifUrl:d,children:[t.jsxs(lt,{children:[t.jsx(xt,{children:"WORKOUT"}),t.jsx(ht,{className:"start",children:t.jsxs(bt,{onClick:h,children:[t.jsx(wt,{className:"start",children:"Start"}),t.jsx(ut,{children:t.jsx("use",{href:`${B}#arrow-add-prod-orange`})})]})})]}),t.jsxs(ft,{children:[t.jsx(pt,{children:t.jsx("use",{href:`${B}#run-man`})}),t.jsx(gt,{children:U(n)})]}),t.jsxs(mt,{children:[t.jsxs(O,{children:["Burned calories:",t.jsx(V,{children:a})]}),t.jsxs(O,{category:!0,children:["Body part:",t.jsx(V,{children:U(i)})]}),t.jsxs(O,{className:"target",children:["Target:",t.jsx(V,{children:U(o)})]})]})]}),t.jsx(A,{onShow:s,onClose:y,children:t.jsx(pe,{exercise:e,openModalExerciseSuccess:b,closeModalExerciseForm:y,setModalExerciseSuccessData:l})}),t.jsx(A,{onShow:u,onClose:v,children:t.jsx(ue,{modalExerciseSuccessData:f,closeModalExerciseSuccess:v})})]})}const vt=r.ul`
  display: flex;
  flex-wrap: wrap;
