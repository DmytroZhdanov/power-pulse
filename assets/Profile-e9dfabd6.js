import{n as t,P,y as oe,z as de,u as O,A as L,C as G,G as le,r as p,j as i,I as $,H as ce,E as S,J as he,K as Q,d as pe,k as E,e as xe,o as me,M as ue,N as ge,g as be,O as we,B as Y,v as V}from"./index-a0934c00.js";import{T as fe}from"./TitlePage-828feaf5.js";import{f as N,C as ye}from"./Calendar-b735a1c7.js";const ve=t.div`
  width: 335px;
  display: flex;
...
`,Ae=t.div`
  ...
  display: flex;
  justify-content: end;
`;function K({fetchBmr:e,setFetchBmr:r}){const[y,{isLoading:b,isError:v,error:U}]=oe(),[w,{data:x,isLoading:F,isError:B,error:D}]=de(),j=O(),c=L(G),d=L(le);p.useEffect(()=>{e&&((async()=>{await w()})(),r(!1))},[e,w,r]);const k=async A=>{A.preventDefault();try{const h=A.target.files[0],T=await y(h).unwrap();j(he(T))}catch(h){console.error(h)}};return i.jsxs(i.Fragment,{children:[i.jsxs(ve,{children:[i.jsxs(je,{children:[i.jsxs(ke,{children:[d?i.jsx("div",{children:i.jsxs("picture",{children:[i.jsx("source",{srcSet:`
                      ${d.avatar_90x90}   90w,
...
`,Oe=new Date(2006,1,1);Oe.getFullYear();const Ge=pe({height:E().required("Please, enter your height").min(150).max(230),currentWeight:E().required("Please, enter your weight").min(35),desiredWeight:E().required("The field is required").min(35),blood:E().required("required"),sex:xe().required("required"),levelActivity:E().required("required")}),Qe={name:"",birthday:"",blood:"",currentWeight:"",desiredWeight:"",height:"",levelActivity:"",sex:""};function ie({setFetchBmr:e}){const[r,y]=p.useState(new Date),b=O(),[v,{isLoading:U,isError:w,error:x}]=Q(),[F,{isLoading:B,isError:D,error:j}]=me(),[c,{isLoading:d,isError:k,error:A}]=ue(),h=L(G),T=L(ge),[m,M]=p.useState(),[te,q]=p.useState(!1),[ae,C]=p.useState(!1);p.useEffect(()=>{(async()=>{try{const{data:W}=await v();M({name:h,...W.user.userParams})}catch(W){M(Qe),console.log(W)}})()},[v,h]);const{values:a,errors:o,touched:u,handleSubmit:re,handleBlur:n,handleChange:s,isValid:ne,isSubmitting:se}=be({initialValues:{...m},validationSchema:Ge,validateOnChange:!0,validateOnBlur:!0,enableReinitialize:!0,onSubmit:async({name:z,...W})=>{const g={...W,birthday:N(r,"yyyy-MM-dd")},R=g.birthday!==N(new Date(m.birthday),"yyyy-MM-dd")||g.blood!==m.blood||g.currentWeight!==m.currentWeight||g.desiredWeight!==m.desiredWeight||g.height!==m.height||g.levelActivity!==m.levelActivity||g.sex!==m.sex;if(z===h&&!R&&(q(!0),setTimeout(q,2e3,!1)),z!==h)try{const f=await c(z).unwrap();b(we(f)),C(!0),setTimeout(C,2e3,!1)}catch(f){console.error(f)}if(R)try{const{user:f}=await F(g).unwrap();M({name:h,...f.userParams}),e(!0),C(!0),setTimeout(C,2e3,!1)}catch(f){console.log(f)}}});return i.jsxs(i.Fragment,{children:[i.jsxs(Se,{autoComplete:"off",onSubmit:re,children:[i.jsxs(Pe,{children:[i.jsxs("label",{htmlFor:"name",children:["Basic info",i.jsx("input",{id:"name",type:"text",name:"name",placeholder:"name",value:a.name||"",onChange:s,onBlur:n}),o.name&&u.name&&i.jsx("p",{children:o.name})]}),i.jsx("input",{id:"email",type:"email",name:"email",placeholder:"email",value:T||"",onChange:s,onBlur:n,disabled:!0}),o.email&&u.email&&i.jsx("p",{children:o.email})]}),i.jsxs(ze,{children:[i.jsxs(Le,{children:[i.jsxs(Z,{htmlFor:"height",children:["Height",i.jsx("input",{id:"height",type:"number",name:"height",placeholder:"0",min:"150",max:"230",value:a.height||"",onChange:s,onBlur:n}),o.height&&u.height&&i.jsx("p",{children:o.height})]}),i.jsxs(Te,{htmlFor:"currentWeight",children:["Current Weight",i.jsx("input",{id:"currentWeight",type:"number",name:"currentWeight",placeholder:"0",min:"35",value:a.currentWeight||"",onChange:s,onBlur:n}),o.currentWeight&&u.currentWeight&&i.jsx("p",{children:o.currentWeight})]})]}),i.jsxs(qe,{children:[i.jsxs(ee,{htmlFor:"desiredWeight",children:["Desired Weight",i.jsx("input",{id:"desiredWeight",type:"number",name:"desiredWeight",placeholder:"0",min:"35",value:a.desiredWeight||"",onChange:s,onBlur:n}),o.desiredWeight&&u.desiredWeight&&i.jsx("p",{children:o.desiredWeight})]}),i.jsx(Ie,{children:i.jsx(X,{selectedDate:r,setSelectedDate:y,onChange:s,onBlur:n})})]})]}),i.jsxs(Ne,{children:[i.jsx(Me,{children:" Blood "}),i.jsxs(Ve,{children:[i.jsxs(Re,{children:[i.jsx(l,{type:"radio",name:"blood",id:"one",value:"1",onChange:s,onBlur:n,checked:a.blood===1||a.blood==="1"}),i.jsx("label",{htmlFor:"one",children:"1"}),o.blood&&u.blood&&i.jsx("p",{children:o.blood}),i.jsx(l,{type:"radio",name:"blood",id:"two",value:"2",onChange:s,onBlur:n,checked:a.blood===2||a.blood==="2"}),i.jsx("label",{htmlFor:"two",children:"2"}),i.jsx(l,{type:"radio",name:"blood",id:"three",value:"3",onChange:s,onBlur:n,checked:a.blood===3||a.blood==="3"}),i.jsx("label",{htmlFor:"three",children:"3"}),i.jsx(l,{type:"radio",name:"blood",id:"four",value:"4",onChange:s,onBlur:n,checked:a.blood===4||a.blood==="4"}),i.jsx("label",{htmlFor:"four",children:"4"})]}),i.jsxs(Ye,{children:[i.jsxs("label",{children:[i.jsx(l,{type:"radio",name:"sex",id:"male",value:"male",onChange:s,onBlur:n,checked:a.sex==="male"}),"Male"]}),i.jsxs("label",{children:[i.jsx(l,{type:"radio",name:"sex",id:"female",value:"female",onChange:s,onBlur:n,checked:a.sex==="female"}),"Female"]}),o.sex&&u.sex&&i.jsx("p",{children:o.sex})]})]}),i.jsxs(_e,{children:[i.jsxs("label",{children:[i.jsx("div",{children:i.jsx(l,{type:"radio",name:"levelActivity",id:"1",value:1,onChange:s,onBlur:n,checked:a.levelActivity===1||a.levelActivity==="1"})}),"Sedentary lifestyle (little or no physical activity)"]}),i.jsxs("label",{children:[i.jsx("div",{children:i.jsx(l,{type:"radio",name:"levelActivity",id:"2",value:"2",onChange:s,onBlur:n,checked:a.levelActivity===2||a.levelActivity==="2"})}),"Light activity (light exercises/sports 1-3 days per week)"]}),i.jsxs("label",{children:[i.jsx("div",{children:i.jsx(l,{type:"radio",name:"levelActivity",id:"3",value:"3",onChange:s,onBlur:n,checked:a.levelActivity===3||a.levelActivity==="3"})}),"Moderately active (moderate exercises/sports 3-5 days per week)"]}),i.jsxs("label",{children:[i.jsx("div",{children:i.jsx(l,{type:"radio",name:"levelActivity",id:"4",value:"4",onChange:s,onBlur:n,checked:a.levelActivity===4||a.levelActivity==="4"})}),"Very active (intense exercises/sports 6-7 days per week)"]}),i.jsxs("label",{children:[i.jsx("div",{children:i.jsx(l,{type:"radio",name:"levelActivity",id:"5",value:"5",onChange:s,onBlur:n,checked:a.levelActivity===5||a.levelActivity==="5"})}),"Extremely active (very strenuous exercises/sports and physical work)"]})]}),o.levelActivity&&u.levelActivity&&i.jsx("p",{children:o.levelActivity})]}),i.jsx(He,{type:"submit",disabled:!ne||se,children:"Save"})]}),te&&i.jsx(Y,{onClose:()=>q(!1),type:"Warning",children:i.jsx(V,{notificationType:"Warning:",message:"No changes to update"})}),ae&&i.jsx(Y,{onClose:()=>C(!1),type:"Success",children:i.jsx(V,{notificationType:"Success:",message:"Your data successfully updated"})}),i.jsx(S,{isLoading:U,isError:w,error:x}),i.jsx(S,{isLoading:B,isError:D,error:j}),i.jsx(S,{isLoading:d,isError:k,error:A})]})}ie.propTypes={setFetchBmr:P.func.isRequired};const Je=t.section`
  padding-top: 40px;
  padding-bottom: 66px;
