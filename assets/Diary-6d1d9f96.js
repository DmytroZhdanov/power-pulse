import{n as i,k as F,j as e,l as r,r as T,L as S,P,e as M,m as Y,I as R}from"./index-c7fab6ee.js";import{T as N}from"./TitlePage-87a27546.js";import{C as U,f as _}from"./Calendar-22c39689.js";import"./tiny-warning.esm-c932d744.js";import"./setPrototypeOf-51e8cf87.js";const Q=i.div`
...
`;function A({selectedDate:n,setSelectedDate:h}){const a=new Date(M(Y)),H=()=>{const v=new Date(n);v.setDate(n.getDate()-1),h(v)},L=()=>{const v=new Date(n);v.setDate(n.getDate()+1),h(v)},O=n.toDateString()===a.toDateString(),q=n.toDateString()===new Date().toDateString();return e.jsxs(we,{children:[e.jsx(ue,{children:e.jsx(U,{onChange:h,value:n,minDate:a,maxDate:new Date,children:e.jsxs(ye,{children:[e.jsxs(be,{children:[" ",_(n,"dd/MM/yyyy")]}),e.jsx(ve,{children:e.jsx(R,{name:"calendar"})})]})})}),e.jsxs("div",{children:[e.jsx(I,{disabled:O,onClick:H,children:e.jsx(R,{name:"nav-arrow-left"})}),e.jsx(I,{disabled:q,onClick:L,children:e.jsx(R,{name:"nav-arrow-right"})})]})]})}A.propTypes={selectedDate:P.instanceOf(Date).isRequired,setSelectedDate:P.func.isRequired};const Te=i.section`
  padding-top: 45px;
  padding-bottom: 80px;
