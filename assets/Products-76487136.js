...
`;function _t({selectedDate:e,setSelectedDate:t}){const r=dt(e,"dd.MM.yyyy");return h.jsx(hn,{maxDate:new Date,onChange:t,value:e,children:h.jsxs(Ro,{children:[h.jsx(ko,{children:r}),h.jsx(Lo,{children:h.jsx(on,{name:"calendar"})})]})})}_t.propTypes={selectedDate:P.instanceOf(Date).isRequired,setSelectedDate:P.func.isRequired};const $o=S.div`
  padding: 48px 24px;
...
`;function Ut(e){const[t,r]=p.useState(new Date),{onClose:i,addProdSuccess:n,addProdError:a,product:s}=e,{weight:o,calories:u,_id:l,title:c}=s,[d,v]=p.useState(o),E=d*u/100,[x]=an(),b={product_ID:l,date:dt(new Date(t),"yyyy-MM-dd"),amount:d,calories:E},g=async()=>{const{error:m}=await x(b);m?a(m.data.message):(i(),n(E))};return h.jsxs($o,{children:[h.jsxs(To,{children:[h.jsx(Bo,{type:"text",value:c,readOnly:!0,disabled:!0}),h.jsxs(jo,{children:[h.jsx(Ho,{type:"number",value:d,onChange:m=>v(m.target.value)}),h.jsx(zo,{children:"grams"})]})]}),h.jsxs(qo,{children:[h.jsx(_t,{selectedDate:t,setSelectedDate:r}),h.jsxs(No,{children:[h.jsx(_o,{children:"Calories:"}),h.jsx(Uo,{children:E})]})]}),h.jsxs(Wo,{children:[h.jsx(Go,{onClick:g,children:"Add to diary"}),h.jsx(Yo,{onClick:i,children:"Cancel"})]})]})}Ut.propTypes={onClose:P.func.isRequired,addProdSuccess:P.func.isRequired,addProdError:P.func.isRequired,product:P.shape({weight:P.number.isRequired,calories:P.number.isRequired,_id:P.string.isRequired,title:P.string.isRequired}).isRequired};const Xo="/power-pulse/assets/avocado-b622cf8b.png",Ko=S.div`
  margin: 12px 70px;
  text-align: center;
  width: 157px;
