...
`;function Jo(){const[n,e]=f.useState(null),[i,r]=f.useState(window.innerWidth>=1440),t=()=>{r(window.innerWidth>=1440)};return f.useEffect(()=>(window.addEventListener("resize",t),()=>{window.removeEventListener("resize",t)}),[]),v.jsxs(v.Fragment,{children:[i&&v.jsx(qo,{}),v.jsxs(Yo,{children:[v.jsx(an,{text:"Products"}),v.jsx($t,{onProductsChange:e})]}),v.jsx(Nt,{filter:n})]})}export{Jo as Products};
